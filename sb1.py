                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['Ada apa sayang tumben ngetag, kangen ya ?','Cie Ngetag Kangen ya ?','Yang tag mudah mudahan jodohnya','Rindu itu berat kamu gk akan kuat']
                ...
                try:
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'dody':
                                client.sendMessage(receiver, 'Nama Dody Fadhlurrahman, Umur 18 Tahun, Jabatan Owner Xcode Gen 2017', contentMetadata={'mid': sender}, contentType=13)
                                ...
                                client.sendText(receiver, "//Created By Dody Fadhlurrahman// Members Grup :"+str(jml))
                                ...
                                if msg.to in cctv['point']:
                                    ...
                                    client.sendText(msg.to, "Heh Belum Juga Diset, Udh Main Offin Aja")
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['Ikut Chat Dong Kak, Gk Enak Tau Cuma Di Read...']
